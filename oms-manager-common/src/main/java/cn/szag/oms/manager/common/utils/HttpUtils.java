...
public class HttpUtils {
    ...
    private static String invokeUrl(String url, Map params, Map<String, String> headers, int connectTimeout, int readTimeout, String encoding, HttpMethod method) {
        ...
        try {
            ...
            logger.info("远程链接返回："+ result.toString());
    ...
    public static void main(String[] args) {
        ...
        params.put("boxNo", "WHLU7758061");
        String str = HttpUtils.get("http://192.168.252.245:8081/uxdar-api2.0/api/getUggEqMessage", params, 3000, 3000, "UTF-8");
